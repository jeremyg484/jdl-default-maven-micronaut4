...
public class AccountResourceIT {
    ...
    public void testGetUnknownAccount() {
        ...
        HttpResponse<String> response = client
            .exchange(HttpRequest.GET("/api/account"), String.class)
    ...
    public void testRegisterInvalidLogin() {
        ...
        HttpResponse<String> response = client
            .exchange(HttpRequest.POST("/api/register", invalidUser), String.class)
            .onErrorReturn(t -> (HttpResponse<String>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void testSaveAccount() {
        ...
        HttpResponse<String> response = client
            .exchange(HttpRequest.POST("/api/account", userDTO), String.class)
            .onErrorReturn(t -> (HttpResponse<String>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
        assertThat(response.status().getCode()).isEqualTo(HttpStatus.OK.getCode());

        verify(userService, times(1)).updateUser("firstname", "lastname", "save-account@example.com", "en", "http://placehold.it/50x50");
    }
    ...
    public void testSaveExistingEmailAndLogin() {
        ...
        verify(userService, times(1))
            .updateUser("firstname", "lastname", "save-existing-email-and-login@example.com", "en", "http://placehold.it/50x50");
    ...
    public void testChangePasswordWrongExistingPassword() {
        ...
        HttpResponse<String> response = client
            .exchange(
                HttpRequest.POST("/api/account/change-password", new PasswordChangeDTO("1" + currentPassword, "new password")),
                String.class
            )
            .onErrorReturn(t -> (HttpResponse<String>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void testChangePassword() {
        ...
        HttpResponse<String> response = client
            .exchange(
                HttpRequest.POST("/api/account/change-password", new PasswordChangeDTO(currentPassword, "new password")),
                String.class
            )
            .onErrorReturn(t -> (HttpResponse<String>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void testRequestPasswordReset() {
        ...
        HttpResponse<String> response = client
            .exchange(
                HttpRequest.POST("/api/account/reset-password/init", "password-reset@example.com").contentType("text/plain"),
