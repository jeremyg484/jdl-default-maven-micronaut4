...
import com.mycompany.myapp.util.HeaderUtil;
import com.mycompany.myapp.util.PaginationUtil;
...
public class UserResource {
    ...
    public HttpResponse<User> createUser(@Valid @Body UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            return HttpResponse
                .<User>created(new URI("/api/users/" + newUser.getLogin()))
                .headers(headers -> HeaderUtil.createAlert(headers, applicationName, "userManagement.created", newUser.getLogin()))
                .body(newUser);
        }
    }
    ...
    public HttpResponse deleteUser(@PathVariable String login) {
        ...
        return HttpResponse
            .noContent()
            .headers(headers -> HeaderUtil.createAlert(headers, applicationName, "userManagement.deleted", login));
    }
}
